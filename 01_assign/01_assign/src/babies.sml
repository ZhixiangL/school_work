...
fun babies_program (fileName, yearSt) =
    ...
    in
      let 
        ...
        fun inputs_search_and_print (i_list : string list) : string = 
          if null i_list
          then ""
          else 
            let
              fun one_name_search_and_print (name: string, records: (string*(int list)*int) list) : string = 
                let
            ...
            in
              one_name_search_and_print (hd i_list, splitted_records_list) ^ inputs_search_and_print (tl i_list)
            end
        
        val _ = print(inputs_search_and_print(input_list))
      in
        ()
      end
    end
