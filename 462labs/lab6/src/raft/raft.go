...
func (rf *Raft) RequestVote(args *RequestVoteArgs, reply *RequestVoteReply) {
	...
	} else if (rf.voteFor <0 || rf.voteFor == args.CandidateId) && ((args.LastLogTerm > rf.lastLogTerm) || (args.LastLogTerm == rf.lastLogTerm && args.LastLogIndex >= rf.lastLogIndex)) {
		rf.voteFor = args.CandidateId
		reply.VoteGranted = true
	} else {
		reply.VoteGranted = false
...
func (rf *Raft) candidateCheck() {
	electionTimeout := rand.Intn(1000)+1000
	for {
